...
插件项目地址：<https://github.com/lj-michale/kual-wifi-transfer>

1. 下载项目代码，可以 `git clone https://github.com/lj-michale/kual-wifi-transfer.git`，也可以直接到项目的 [releases](https://github.com/lj-michale/kual-wifi-transfer/releases) 下载 zip 文件；

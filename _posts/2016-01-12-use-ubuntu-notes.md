...
```
export ANDROID_SDK_HOME=/home/lj-michale/android/sdk
...
Exec=/home/lj-michale/android/eclipse/eclipse
Icon=/home/lj-michale/android/eclipse/icon.xpm
StartupNotify=true
Terminal=false
Type=Application
```
...
```sh
lj-michale@ubuntu:~$ ll ~/.ssh
total 20
drwx------  2 lj-michale lj-michale 4096 Jun 22 01:03 ./
drwxr-xr-x 20 lj-michale lj-michale 4096 Jun 22 01:02 ../
-rw-------  1 lj-michale lj-michale 1679 Jun 21 05:17 id_rsa
-rw-r--r--  1 lj-michale lj-michale  399 Jun 21 05:17 id_rsa.pub
```

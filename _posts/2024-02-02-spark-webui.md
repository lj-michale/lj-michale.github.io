...
- [Jobs]()
  ![img](/images/posts/bigdata/f0a0b2b8b0994a15b95fa7c25f7ba747.png)
  ```.text
  ...
  ```
    ...
    - [Jobs Detail]()
      > 点击Event Timeline后可以看到以下信息: <br>
      ![img](/images/posts/bigdata/6a9fbf9a3f4c4b3a99a82addd74f35e0.png)
      ```.text
      ...
      ```
      ![img](/images/posts/bigdata/3adc1f679813498f9fbf526e964a7aa7.png)


- [Stages]()
  ![img](/images/posts/bigdata/83a3f4eca4e343b1b0b8fafecd190ca6.png)
  ```.text
  ...
  ```
    - [关于stage列表页的场景问题]()
      ...
      ```
      ![img](/images/posts/bigdata/3ccb62fca4ac46cbbcd545a470e8246f.png)
      ...
      ```
      ![img](/images/posts/bigdata/83f7877c9700420d86e1658da62c097b.png)
      ...
      ```
      ![img](/images/posts/bigdata/1fcf0e35f4334f4cb31895e05aa16c27.png)
      ```.text
      ...
      ```
      ![img](/images/posts/bigdata/574e91c62b714856b9cc95cc52c2edf7.png)
      > 有的stage会显示xxtask failed，代表什么意思呢，为什么task失败stage不会失败呢 ? <br>
      ![img](/images/posts/bigdata/c358d5ecdf6341c781c3a2358a5a4f1c.png)
      ```.text
    ...
    - [Stage detail]()
      ...
      ![img](/images/posts/bigdata/b2a38bbb8748496cbd0cc5fbbe60688f.png)
        - [Locality level]()
          ```.text
        ...
        - [Event Timeline]()
          ...
          ```
          ![img](/images/posts/bigdata/1447a8d9858d40ff950aba804b0d7b9c.png)
          ```.text
        ...
        - [Summary Metrics]()
          > 此处是所有task的统计信息 <br>
          ![img](/images/posts/bigdata/aa07cdcc5fd44839bf4023282f68886a.png)
          ```.text
        ...
        - [Aggregated Metrics by Executor]()
          ![img](/images/posts/bigdata/9ba56e7fb7a14bd8aa88f2c6483d8e9e.png)
          ```.text
    
          ```
        - [Tasks]()
          > 每个task的明细信息，显示的指标受“Show Additional Metrics”中勾选的指标多少，在executor和task模块下都可以通过点击Logs来看executor的日志 <br>
          ![img](/images/posts/bigdata/ddde651147104e55822c7c72a77ce5e3.png)
    - [关于stage detail的问题]()
      ...
      ```
      ![img](/images/posts/bigdata/00cf0d697fc7400b8ec2d3fdb696b874.png)
      ```.text
      ...
      ```
      ![img](/images/posts/bigdata/12b98809b4eb4136b6c279e2f88952e0.png)
...
- [Storage]()
  ...
  ```
  ![img](/images/posts/bigdata/030bba52a3a54e96b345a3d8e06c266c.png)
  > 点击具体的RDD后，可以看到下面的详细信息 <br>
  ![img](/images/posts/bigdata/0ae2bd887bc64e68b31ad50d42f2c628.png)
    - [关于storage页面的问题]()
      > StorageLevel都有哪些 ？<br>
      ```.text
      ...
      ```
      ![img](/images/posts/bigdata/3a58b9e4d82d43cd843ce535c2215842.png)
      ```.text
...
- [Environment]()
  ...
  ```
  ![img](/images/posts/bigdata/bcf1b0ce6e9e49b59a9dfd802a6b6b85.png)
...
- [Executors]()
  ...
  ```
  ![img](/images/posts/bigdata/3770ed2554fe4b46825c9735b19999ed.png)
    ...
    - [关于Executors页面的问题]()
      ...
      ```
      ![img](/images/posts/bigdata/64d404a321eb45cda7c0cd432d243874.png)
      ```.text
      ...
      ```
      ![img](/images/posts/bigdata/26345663a4f940d19e43a1a96a610154.png)
      > 以下面参数设置为例 <br>
      ```.text
      ...
      ![img](/images/posts/bigdata/18d3d9132e0f48c4a643dc5b70bdd33b.png)
      ```.text
      ...
      ``` 
      ![img](/images/posts/bigdata/8d226862b74740fe806c59c91f60296e.png)
      ```.text
       关闭后，storage memory变为了850.5MiB，GC日志中新生代的实际可用内存也不再变化
      ```
      ![img](/images/posts/bigdata/26f475ee0f50486582558ef069f311c9.png)
      ```.text
...
- [SQL]()
  ...
  ```
  ![img](/images/posts/bigdata/e0fab0e71e5b42549779129c11ba020b.png)
  ...
  ``` 
  ![img](/images/posts/bigdata/ee1d6dce563741d79660860ab4d175e3.png)
  ```.text
  ...
  ``` 
  ![img](/images/posts/bigdata/0852d7884e0c40caa7366c06b1f3b041.png)
    - [关于SQL页面的问题]()
      ...
      > 1.判断是否谓词下推 <br>
      ![img](/images/posts/bigdata/0573525d871c4a53b91a57a575c27f97.png)

      > 2.判断join的方式，是SortMergeJoin还是broadcast join <br>
      ![img](/images/posts/bigdata/a5533d19d6a348bbb3ccb0e22c9ae101.png)

      > 3.判断各类操作下，有没有数据和时间倾斜 <br>
      ![img](/images/posts/bigdata/d9158247c9534adf8808e16321495147.png)

      > 4.怀疑有数据膨胀时，可以定位分析 <br>
      ![img](/images/posts/bigdata/2525c268ab594d8a8b3ff01eb59865a3.png)
...
- [Debug]()
  ...
  ```
  ![img](/images/posts/bigdata/5561e7799b5946ac82f5c3971acc4501.png)

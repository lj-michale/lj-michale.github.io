...
GitHub 仓库地址：<https://github.com/lj-michale/csdncommenter>
...
遂在 GitHub 上建了个仓库开工，地址在这里：<https://github.com/lj-michale/csdncommenter>。
...
（GitHub 仓库：[lj-michale/csdncommenter](https://github.com/lj-michale/csdncommenter)，现在可以通过 pip 安装使用了  `pip install csdncommenter`  然后  `csdncommenter`。2015/10/27 update）

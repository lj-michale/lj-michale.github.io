...
1. 在你的 vimrc 文件中添加如下内容：
   ...
   ```markdown
   Plugin 'lj-michale/vim-kramdown-tab'
   ```
...
[2]: https://github.com/lj-michale/vim-kramdown-tab
[3]: http://github.com/VundleVim/Vundle.Vim
[4]: https://raw.githubusercontent.com/lj-michale/vim-kramdown-tab/master/screenshots/test.gif

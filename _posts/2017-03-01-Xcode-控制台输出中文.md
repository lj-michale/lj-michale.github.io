...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"BY",
                           @"My bolg" : @"http://lj-michale.top",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"Tony Blog:http://lj-michale.top",
                                          @"GitHub:https://github.com/lj-michale",
...
代码及Demo地址：[GitHub](https://github.com/lj-michale/BYFoundationLog)
